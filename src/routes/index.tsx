      ...
      <header className="sticky top-0 z-50 border-b border-border/40 bg-background/60 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-4 md:px-8">
          ...
          <motion.div
            ...
            className="hidden items-center gap-3 rounded-full bg-primary px-4 py-1.5 shadow-lg shadow-primary/20 md:flex"
          >
            <Calendar className="h-3.5 w-3.5 text-primary-foreground" />
            <span className="font-mono text-[10px] font-black tracking-widest text-primary-foreground uppercase">
